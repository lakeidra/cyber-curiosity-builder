    ...
    <Layout>
      ...
      <section className="bg-navy text-cream">
        <div className="container-page py-24 md:py-32 max-w-[860px]">
          <AnimatedSection>
            <p className="eyebrow mb-6">nsite by The Cyber Consultant</p>
            <h1 className="font-serif text-[40px] md:text-5xl lg:text-[4rem] leading-[1.1] mb-6">
              The AI adoption diagnostic that measures your people,{" "}
              <em className="text-gold">not just your tools.</em>
            </h1>
      ...
      <section className="bg-cream">
        <div className="container-page py-24 md:py-32">
          <AnimatedSection>
            <p className="eyebrow mb-4 text-gold-dark">The Measurement Model</p>
            <h2 className="font-serif text-[32px] md:text-[44px] leading-[1.15] mb-6 max-w-[760px]">
              Three layers. One composite score. A clear path forward.
            </h2>
          ...
          <AnimatedSection>
            <div className="bg-navy text-cream rounded-lg p-8 md:p-12 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="border border-gold/30 rounded-lg p-8 bg-navy-light">
                <p className="text-cream/60 text-sm mb-5 uppercase tracking-wider font-sans">
                  We measure impactful adoption, not just adoption
                </p>
            ...
            {[
              ...
              <AnimatedSection key={item.step} delay={i * 0.08}>
                <div className="flex gap-6 items-start border-b border-gold/20 pb-8">
                  <span className="font-serif text-gold-dark text-[28px] leading-none mt-1 min-w-[130px] shrink-0">
                    {item.step}
                  </span>
        ...
        <div className="container-page py-20 md:py-24 text-center max-w-[680px] mx-auto">
          <AnimatedSection>
            <h2 className="font-serif text-[28px] md:text-[38px] leading-[1.15] mb-4">
              nsite is one part of a broader AI adoption practice.
            </h2>
            <p className="text-muted-foreground text-[16px] leading-[1.7] mb-8">
              The diagnostic is where we start, but not where we stop. Explore our full AI Readiness & Adoption service to see what comes next: strategy, automation, and training.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="hero-primary" size="lg" asChild>
                <Link to="/services/ai-readiness">
                  See Full AI Readiness Service <ArrowRight className="ml-1" size={16} />
                </Link>
              </Button>
