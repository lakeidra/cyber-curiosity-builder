        ...
        <div className="container-page py-20 md:py-28 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <AnimatedSection>
            ...
            <div className="flex gap-3 md:gap-4">
              <Button variant="hero-primary" size="lg" className="whitespace-nowrap text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-6" asChild>
                <Link to="/scorecard">Assess Your Board Readiness</Link>
              </Button>
              <Button variant="hero-secondary" size="lg" className="whitespace-nowrap text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-6" asChild>
